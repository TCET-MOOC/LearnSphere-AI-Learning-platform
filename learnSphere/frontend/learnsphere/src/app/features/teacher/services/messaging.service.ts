...
/**
 * MessagingService (teacher) — mirrors student/admin messaging.service.ts.
 * Real HTTP calls against the shared /api/conversations backend.
 */
@Injectable({
  providedIn: 'root'
})
export class MessagingService {
  ...
  // Returns all conversations for the current teacher.
